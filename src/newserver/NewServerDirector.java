...
public class NewServerDirector {
	/* Game States */
	 ...
	 */
	public NewServerDirector(Server server) {
		this.server = server;
	...
	public void updatePlayer(JSONObject obj) {
		/* THIS METHOD SEEMS TO BREAK THE STREAMS, AND SO FAR THE GAME
		 * WORKS FINE WITHOUT IT! SO WE MIGHT WANT TO REMOVE IT!!!
		 */
	}
