...
public class NewBoardState extends State {
	...
	public NewBoardState(NewDirector director) {
		super(director);
	}
	 ...
	 *
	 */
	class BoardPanel extends JPanel implements ComponentListener, MouseListener, MouseMotionListener {
